...
p_1plus2 = initialize_prob(Float64, energies, freqs, sats, pols, k_relative, beam_radius, d, m/(ħ*k^2/Γ), Γ, k, sim_params, update_p_1plus2!, add_terms_dψ!, 1:12, 13:16)
...
prob_1plus2 = ODEProblem(ψ_update!, p_1plus2.u0, t_span, p_1plus2; kwargs...)

# PROBLEM TO COMPUTE DIFFUSION #
p_1plus2_diffusion = initialize_prob(Float64, energies, freqs, sats, pols, k_relative, beam_radius, d, m/(ħ*k^2/Γ), Γ, k, sim_params, update_p_1plus2_diffusion!, add_terms_dψ!, 1:12, 13:16)
...
prob_1plus2_diffusion = ODEProblem(ψ_update_ballistic!, p_1plus2_diffusion.u0, t_span, p_1plus2_diffusion; kwargs...)
